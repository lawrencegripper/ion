...
func GetSharedSidecarArgs(c *types.Configuration, sbKeys servicebus.AccessKeys) []string {
	return []string{
		...
		"--mongodbdocprovider.collection=" + c.Sidecar.MongoDBMetaProvider.Collection,
		"--mongodbdocprovider.name=" + c.Sidecar.MongoDBMetaProvider.Name,
		"--mongodbdocprovider.password=" + c.Sidecar.MongoDBMetaProvider.Password,
		"--mongodbdocprovider.port=" + strconv.Itoa(c.Sidecar.MongoDBMetaProvider.Port),
